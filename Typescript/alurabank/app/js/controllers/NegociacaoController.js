        ...
        execute: function () {
            NegociacaoController = class NegociacaoController {
                constructor() {
                    ...
                    this._negociacoesView = new index_1.NegociacoesViews('#negociacoesView');
                    this._mensagemView = new index_1.MensagemView('#mensagemView');
                    this._service = new NegociacaoService_1.NegociacaoService();
                    this._negociacoesView.update(this._negociacoes);
                }
                adiciona() {
                    let data = new Date(this._inputData.val().toString());
                    if (!this._DiaUtil(data)) {
                        this._mensagemView.update('Somente negociações em dias úteis.');
                        return;
                    }
                    const negociacao = new index_2.Negociacao(data, Number(this._inputQuantidade.val()), Number(this._inputValor.val()));
